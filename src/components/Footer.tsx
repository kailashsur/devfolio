  ...
  return (
    <div className={clsx('max-w-[348px]')}>
      ...
      <p className={clsx('mb-4 font-normal leading-relaxed')}>
        I&apos;m Kailash, a <strong>full-stack web developer </strong>passionate about crafting user-friendly, elegant, and contemporary interfaces.
      </p>
      <ul className={clsx('-ml-2 flex gap-1')}>
        <li>
          <a
            href="https://twitter.com/surkailash"
            target="_blank"
            rel="noreferrer nofollow"
